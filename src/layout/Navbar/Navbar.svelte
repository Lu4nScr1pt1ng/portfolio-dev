...
<header>
    <div class="tab-nav-container text-sm   w-[275px] sm:w-[375px] lg:w-[475px] p-[12px] sm:p-[24px]">
        <a href="#Hero" class:active={isUrlContainPath($page.url.pathname, "/")} class="tab purple">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-[0.8em] h-[0.8em] sm:w-[1.2em] sm:h-[1.2em]"  version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
                <g>
        ...
        <a class:active={isUrlContainPath($page.url.pathname, "/#About")} href="#About" class="tab pink">
